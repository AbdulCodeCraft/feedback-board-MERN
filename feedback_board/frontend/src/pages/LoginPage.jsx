...
const LoginPage = () => {
  ...
  return (
    ...
    <div
      className="w-screen min-h-screen bg-[url('/images/landing_bg.jpg')] bg-cover bg-center flex items-center justify-center p-4 sm:p-6"
    >
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-5xl bg-white/10 bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl overflow-hidden border border-white border-opacity-30">
        ...
        <div className="p-6 sm:p-8 lg:p-12 lg:w-1/2 flex items-center justify-center flex-col">
          ...
          <div className="mt-6 text-center text-black text-opacity-80">
            <p className="font-semibold text-lg">For demo purposes:</p>
            <p className="text-sm mt-1">
              <span className="font-bold">User:</span> username: `user`, password: `userpassword`
            </p>
            <p className="text-sm">
              <span className="font-bold">Admin:</span> username: `admin`, password: `adminpassword`
            </p>
          </div>
        </div>
      </div>
